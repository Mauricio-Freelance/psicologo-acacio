...
`,ee=c.span`
    ...
    color: inherit;
`,te="home",Ne="about",Le="contact",Ue="benefits",Pe="faq",Fe="work",Zt=()=>{const[e,t]=P.useState(!1),i=()=>{t(!e),console.log("Menu state:",!e)},[n,r]=P.useState(`/${te}`),a=d=>{r(d);const g=d.replace("/",""),p=document.getElementById(g);p&&p.scrollIntoView({behavior:"smooth"})},s=()=>{const d=[te,Fe,Ne,Ue,Pe,Le];let g=te;for(const p of d){const x=document.getElementById(p);if(x){const y=x.getBoundingClientRect();if(y.top<=100&&y.bottom>=100){g=p;break}}}r(`/${g}`)},u=(d,g)=>{let p;return function(...x){clearTimeout(p),p=setTimeout(()=>d.apply(null,x),g)}};return P.useEffect(()=>{s();const d=u(s,0);return window.addEventListener("scroll",d),()=>{window.removeEventListener("scroll",d)}},[]),o.jsxs(hr,{children:[o.jsx(mr,{onClick:i,src:e?$.close:$.burger,alt:"Menu"}),o.jsxs(fr,{isMenuOpen:e,children:[o.jsx(_,{onClick:()=>a(`/${te}`),children:o.jsx(ee,{style:{color:n===`/${te}`?m.primary:"inherit"},children:"Home"})}),o.jsx(_,{onClick:()=>a(`/${Fe}`),children:o.jsx(ee,{style:{color:n===`/${Fe}`?m.primary:"inherit"},children:"Meu Trabalho"})}),o.jsx(_,{onClick:()=>a(`/${Ne}`),children:o.jsx(ee,{style:{color:n===`/${Ne}`?m.primary:"inherit"},children:"Sobre"})}),o.jsx(_,{onClick:()=>a(`/${Ue}`),children:o.jsx(ee,{style:{color:n===`/${Ue}`?m.primary:"inherit"},children:"Benefícios"})}),o.jsx(_,{onClick:()=>a(`/${Pe}`),children:o.jsx(ee,{style:{color:n===`/${Pe}`?m.primary:"inherit"},children:"FAQ"})}),o.jsx(_,{onClick:()=>a(`/${Le}`),children:o.jsx(ee,{style:{color:n===`/${Le}`?m.primary:"inherit"},children:"Contatos"})})]})]})},gr=c.div`
...
`,$r=c.p`
    ...
    width: 70%;
    text-align: center;
`,At=({imagePath:e,alt:t,legend:i,backgroundColor:n="#07A8b0",color:r="#FFF"})=>o.jsxs(Ir,{children:[o.jsx(Tr,{src:e,alt:t}),o.jsx(Mr,{style:{backgroundColor:n,color:r},children:o.jsx($r,{children:i})})]}),zr=""+new URL("home-Crs8Dc1F.png",import.meta.url).href,Or=""+new URL("about-CjJHMpFW.png",import.meta.url).href,Dr=""+new URL("contact-CGsrFhA8.png",import.meta.url).href,jt={home:zr,about:Or,contact:Dr},Nr=c.section`
    display: flex;
    flex-direction: column;
    align-items: center;
    min-width: 100vw;
...
`,Do=()=>o.jsx(le,{id:Le,children:o.jsxs(Io,{children:[o.jsx(To,{children:"Entre em contato e agende já sua consulta."}),o.jsxs(Mo,{children:[o.jsxs($o,{children:[o.jsx(Te,{children:"Telefone: +55 88 9958-0857"}),o.jsx(Te,{children:"WhattsApp: +55 88 9958-0857"}),o.jsx(Te,{children:"Email: acaciofh@gmail.com"}),o.jsx(Te,{children:"Ou"}),o.jsx(zo,{children:o.jsx(_e,{backgroundColor:"white",color:"#07A8b0",iconSrc:$.whatsApp})})]}),o.jsx(Oo,{children:o.jsx(At,{backgroundColor:"white",color:"#07A8b0",imagePath:jt.contact,alt:"Psicólogo Acácio Tórres",legend:"Raimundo Acácio Costa Tôrres Filho CRP 11ª - 04373"})})]})]})});function No(){return o.jsxs("div",{children:[o.jsx(vr,{}),o.jsx(Lr,{}),o.jsx(to,{}),o.jsx(po,{}),o.jsx(go,{}),o.jsx(Ro,{}),o.jsx(Do,{})]})}Li.createRoot(document.getElementById("root")).render(o.jsx(P.StrictMode,{children:o.jsx(No,{})}));
